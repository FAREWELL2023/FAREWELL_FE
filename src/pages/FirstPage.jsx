...
const FirstPage = () => {
    ...
    return (
        <Wrapper>
            ...
            <TxtBox>
                <TitleLine><img src={my2023}/><Title>내가 쓰는 나의 2023</Title></TitleLine>
                <SubTxt>2023년을 마무리하는 문답에 답하며<br/>나의 2023년을 되돌아보세요!</SubTxt>
            </TxtBox>
            <TxtBox style={{marginTop: "-10px"}}>
                <TitleLine><img src={people2023}/><Title>남이 쓰는 나의 2023</Title></TitleLine>
                <SubTxt>익명으로 질문에 답하며<br/>
                친구들의 2023 회고에 참여해보세요!<br/><br/>

                익명을 통해 그동안 전하지 못했던 말을<br/>
